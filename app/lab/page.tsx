      ...
      <section className="relative mx-auto max-w-7xl px-4 py-24 md:px-6 flex flex-col gap-18">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-base leading-7 text-zinc-400 md:text-lg">
            A playground for experiments, prototypes, mini games, developer
            tools, interaction concepts, and ideas that don’t belong in the main
            portfolio.
          </p>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2 h-fit">
            {experiments.map((item) => (
              ...
              >
                ...
                <Link href={""} className="text-sm text-cyan-300 transition group-hover:translate-x-1">
                  Open Experiment
                </Link>
              </div>
            ))}
        ...
        <section className="rounded-3xl backdrop-blur-xl border border-white/10 p-8 md:p-12">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 leading-7 text-zinc-400">
              The lab is where concepts become experiments and experiments
              become products.
            </p>
